...
public class ChapterAdapter extends ArrayAdapter<ChapterBean> {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if(row==null){
            ...
            holder.seenImage=(ImageView)row.findViewById(R.id.ivSeenadapter);
        ...
        if(chapterBean.getChapterSeen()==true){
            holder.seenImage.setImageDrawable(this.getContext().getDrawable(R.drawable.seeneye));
            holder.background.setBackground(this.getContext().getDrawable(R.drawable.round_seen));
        }else{
            holder.seenImage.setImageDrawable(this.getContext().getDrawable(R.drawable.notseeneye));
